...
class ScriptLogger:
    ...
    def __init__(self, nombre_logger="mi_logger", nivel=10, csv_path=None):
        ...
        self.console = Console()  # consola Rich global
    ...
    def _log(self, nivel, mensaje):
        ...
        # Parte fija en blanco: Execution ID, hora y tiempo transcurrido
        parte_fija = f"[white][{self.execution_id}] [{hora_actual}] [{ts_rel}][/white]"

        # Parte de mensaje con icono y color según nivel
        ...
        if nivel in ("STEP", "INFO", "SUCCESS"):
            ...
            self._hubo_error = True  # marcar que hubo error real
