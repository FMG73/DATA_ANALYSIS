...
CARD_STYLES = {
    ...
    "row_vehiculos": {  # fila de vehículos
        "card_bg": "#111827",
        "border_color": "#334155",
        "border_width": 1.5,
        "shadow": {
...
def draw_row_as_image(cards, row_name, filename, width=18, height=3):
    """
    Dibuja una fila de tarjetas y guarda como imagen
    """
    fig = plt.figure(figsize=(width, height))
    draw_row(fig, 0, 1, cards, row_name)
    plt.axis("off")
...
# ======================================================
# CREAR Y GUARDAR CADA FILA COMO IMAGEN
# ======================================================
draw_row_as_image(ROW_2_CARDS, "row_usuarios", "fila_usuarios.png")
draw_row_as_image(ROW_3_CARDS, "row_vehiculos", "fila_vehiculos.png")

# ======================================================
# OPCIONAL: CREAR TÍTULO COMO IMAGEN SEPARADA
# ======================================================
fig_title = plt.figure(figsize=(18, 2))
ax_title = fig_title.add_axes([0,0,1,1])
ax_title.axis("off")
ax_title.text(
    0.5, 0.5,
    "Dashboard Ventas – KPIs Operativos",
    ha="center", va="center",
    fontsize=30,
    fontweight="bold"
)
plt.savefig("dashboard_title.png", dpi=150, bbox_inches="tight", transparent=True)
plt.close(fig_title)
