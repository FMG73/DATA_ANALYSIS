# melloger/script_logger_final_prd_v2.py
...
class ScriptLogger:
    ...
    - Identificador de ejecución total en CSV
    """
    ICONOS = {
        "STEP": "▶",
        "INFO": "🛈",
    ...
    def __init__(self, nombre_logger="mi_logger", nivel=10, csv_path=None):
        ...
        if self.csv_path:
            ...
            # Escribir cabecera CSV si no existe
    ...
    def fin_script(self, mensaje="FIN SCRIPT"):
        ...
        # Guardar en CSV con columna TOTAL marcada
        if self.csv_path:
    ...
    def _log(self, nivel, mensaje):
        ...
        if self.csv_path:
            ...
            fila = [
                ...
                ts_rel,
                self.ruta_main,
                False  # columna TOTAL = False para pasos individuales
            ]
            with open(self.csv_path, "a", newline="", encoding="utf-8") as f:
                writer = csv.writer(f, delimiter=";")
