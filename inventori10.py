...
def procesar_stages_largo(
    ...
    """
    Versión optimizada:
    - Usa .map() vectorizado para asignar grupos (sin apply lento)
    - Mantiene solo apply sobre listas pequeñas (no afecta rendimiento)
    """
    ...
    # Crear diccionario invertido: stage → grupo
    map_stage_grupo = {
        stage: grupo
    ...
    def limpiar_lista(lista, excluir):
        # Si solo hay excluidos → se mantienen
