...
class ScriptLogger:
    ...
    def __init__(self, nombre="SCRIPT", csv_path="log.csv"):
        ...
        # 🔥 estado SOLO para spinner (PRO)
        self._spinner_task = "Iniciando..."

        self._init_csv()

    # =====================================================
    # CONTROL DE TASK (SPINNER)
    # =====================================================

    def _set_task(self, msg: str):
        """Solo afecta al spinner (no al log interno)"""
